...
### DataBase
- :clock1130: [Database Management System (DBMS)](https://www.geeksforgeeks.org/dbms/)
- :clock1130: [PostgreSQL Tutorial](https://www.postgresqltutorial.com/)
- :recycle: [How Sharding Works](https://medium.com/@jeeyoungk/how-sharding-works-b4dec46b3f6)
- :recycle: [Deadlock in DBMS](https://www.geeksforgeeks.org/deadlock-in-dbms/)
- :recycle: [Database Recovery Techniques in DBMS](https://www.geeksforgeeks.org/database-recovery-techniques-in-dbms/)
- :recycle: [N+1 Queries and How to Avoid Them!](https://medium.com/@bretdoucette/n-1-queries-and-how-to-avoid-them-a12f02345be5)
- :recycle: [Codd's 12 rules](https://en.wikipedia.org/wiki/Codd%27s_12_rules)
- :clock1130: [DBMS & SQL Tutorial for Beginners](https://www.studytonight.com/dbms/)
- :recycle: [What is a Key-Value Database?](https://www.dataversity.net/key-value-database/)
- :recycle: [Graph Databases. What’s the Big Deal?](https://towardsdatascience.com/graph-databases-whats-the-big-deal-ec310b1bc0ed)
- :recycle: [What is a Document Database?](https://www.alachisoft.com/nosdb/document-databases.html)
- :recycle: [What is a Wide Column Database?](https://www.dataversity.net/wide-column-database/)
- :recycle: [An Overview on Elasticsearch and its usage](https://towardsdatascience.com/an-overview-on-elasticsearch-and-its-usage-e26df1d1d24a)
